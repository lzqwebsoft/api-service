...
<template>
  <div class="flex w-full h-screen">
    ...
    <!-- 弹出滑动验证码 -->
    <ElDialog v-model="captchaVisible" title="安全验证" width="340px" destroy-on-close align-center
      :close-on-click-modal="false" class="captcha-dialog">
      <div class="flex justify-center items-center py-2">
        <Slide v-if="captchaData.image" :config="captchaConfig" :data="captchaData" :events="captchaEvents"
          ref="slideRef" />
